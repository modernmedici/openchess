...
export const openings = [
...

  {
    ...
    moves: [
      { san: 'e4', commentary: "e4 — the King's Pawn, and we're heading for one of the most theoretically explored variations in modern top-level chess." },
      { san: 'e5', commentary: "e5 — Black mirrors the center. The Berlin Defense will arise from this classical symmetry." },
      { san: 'Nf3', commentary: "Nf3 — developing with tempo, attacking e5. White sets up the Ruy Lopez bishop move on the next turn." },
      { san: 'Nc6', commentary: "Nc6 — defending e5 while developing. This leads to the main Ruy Lopez complex." },
      { san: 'Bb5', commentary: "Bb5 — the Spanish bishop! White pins the c6 knight and pressures the center. Now Black chooses between a6 (Morphy Defense) or Nf6 (the Berlin)." },
      { san: 'Nf6', commentary: "Nf6 — the Berlin Defense! Black counter-attacks e4 immediately rather than playing a6. This move was considered harmless for decades but became the most solid equalizing weapon at world championship level after Kramnik used it against Kasparov in 2000." },
      { san: 'O-O', commentary: "O-O — White castles, a key move. Rather than defending e4, White allows the knight to take it. After O-O, the Berlin Endgame arises: Black takes on e4, White attacks the knight, and after a forced sequence queens come off the board, leading to a legendary endgame battle." },
      { san: 'Nxe4', commentary: "Nxe4 — Black captures the e4 pawn! The Berlin Endgame begins. After d4 d6 Bxc6+ dxc6 dxe5 Nf6+ Qxd8+ Kxd8, queens are exchanged early. Black has doubled pawns but active pieces. World champions have battled in this endgame for decades — it's one of the most analyzed positions in chess." },
    ]
  },

  {
    ...
    moves: [
      { san: 'e4', commentary: "e4 — the King's Pawn. White heads for the Exchange Variation of the Ruy Lopez, one of the most direct and strategically clear variations." },
      { san: 'e5', commentary: "e5 — Black occupies the center. The Exchange Ruy Lopez arises when White decides to trade the bishop for the knight immediately." },
      { san: 'Nf3', commentary: "Nf3 — developing with tempo. The standard Ruy Lopez setup begins." },
      { san: 'Nc6', commentary: "Nc6 — defending e5 naturally. Black is set up for the main Ruy Lopez when White springs the Exchange Variation." },
      { san: 'Bb5', commentary: "Bb5 — the Spanish bishop takes aim at the c6 knight. The Exchange Variation is now just one move away." },
      { san: 'a6', commentary: "a6 — Black challenges the bishop, expecting Ba4. But White has other plans — the immediate exchange!" },
      { san: 'Bxc6', commentary: "Bxc6 — the Exchange Variation! White immediately takes the knight, giving Black doubled pawns. White sacrifices the bishop for a knight and gives Black the bishop pair. The compensation is a long-term structural advantage: Black's doubled c-pawns are a permanent weakness that must be nursed into a winning endgame." },
      { san: 'dxc6', commentary: "dxc6 — Black recaptures with the d-pawn, opening the d-file and the diagonal for the dark-squared bishop. Black has the bishop pair and active piece play, but the doubled c-pawns will be a target for the rest of the game. Fischer famously played this as White, grinding out many famous endgame victories." },
    ]
  },

  {
    ...
    moves: [
      { san: 'e4', commentary: "e4 — the King's Pawn, beginning the most deeply analyzed opening system in chess history." },
      { san: 'e5', commentary: "e5 — Black meets the center challenge directly, setting up the classical open game." },
      { san: 'Nf3', commentary: "Nf3 — developing with tempo, attacking e5 and preparing the Ruy Lopez bishop." },
      { san: 'Nc6', commentary: "Nc6 — defending e5 while developing the knight to its best square." },
      { san: 'Bb5', commentary: "Bb5 — the Spanish bishop! White pins the c6 knight and applies indirect pressure on e5." },
      { san: 'a6', commentary: "a6 — the Morphy Defense. Black immediately challenges the bishop, forcing White to declare intentions." },
      { san: 'Ba4', commentary: "Ba4 — White retreats, maintaining the pin. The tension is kept alive. Now the Closed Ruy Lopez begins in earnest — the most important and deeply analyzed opening in all of chess history." },
      { san: 'Be7', commentary: "Be7 — a key move in the Closed Ruy Lopez! Black develops the bishop and prepares to castle. This solid approach leads to the main Closed Ruy Lopez where White will play O-O, Re1, c3, d4 while Black counters with ...b5, ...d6, and the thematic ...Na5 or ...Nb8-d7. Decades of theoretical battles follow from here." },
    ]
  },

  {
    ...
    moves: [
      { san: 'e4', commentary: "e4 — the King's Pawn. The Marshall Attack is one of the most heavily analyzed gambits in chess, requiring knowledge of theory up to move 20+." },
      { san: 'e5', commentary: "e5 — Black mirrors the center, heading for the Ruy Lopez main line that will eventually diverge into the Marshall." },
      { san: 'Nf3', commentary: "Nf3 — developing with tempo. The standard Ruy Lopez setup begins." },
      { san: 'Nc6', commentary: "Nc6 — defending e5. Both sides are following the main Ruy Lopez path." },
      { san: 'Bb5', commentary: "Bb5 — the Spanish bishop. White is heading into the most theoretically rich continuation." },
      { san: 'a6', commentary: "a6 — the Morphy Defense, keeping maximum tension. Black is following the exact path that will later lead to the Marshall sacrifice." },
      { san: 'Ba4', commentary: "Ba4 — White maintains the pin. This position will evolve through O-O, Be7, Re1, b5, Bb3, O-O, c3 before Black unleashes the Marshall pawn sacrifice with d5, giving up a pawn for a fierce kingside attack." },
...

  {
    ...
    moves: [
      { san: 'e4', commentary: "e4 — the King's Pawn, one of the oldest and most popular openings in chess history." },
      { san: 'e5', commentary: "e5 — Black mirrors the center. The Giuoco Piano is one of the oldest recorded openings, with games dating back to the 16th century." },
      { san: 'Nf3', commentary: "Nf3 — developing with tempo, attacking e5. White builds toward the Italian Game complex." },
      { san: 'Nc6', commentary: "Nc6 — defending e5 while developing. Both sides are following the most classical development principles." },
      { san: 'Bc4', commentary: "Bc4 — the Italian bishop! The bishop aims at the critical f7 square and prepares to participate in the center battle. This is one of the oldest developing moves in chess — the Via Italiana." },
      { san: 'Bc5', commentary: "Bc5 — Black mirrors the strategy with an equally active bishop! Both bishops eye the opponent's f2/f7 weaknesses. The position is completely symmetrical and balanced — the 'Quiet Game' (Giuoco Piano in Italian) begins." },
      { san: 'c3', commentary: "c3 — White prepares d4! This is the Giuoco Piano's characteristic move, building a strong pawn center. White plans c3-d4, challenging Black's bishop and gaining central space. The position transitions from symmetrical to dynamic." },
      { san: 'Nf6', commentary: "Nf6 — Black counter-attacks e4 rather than waiting for White's d4! This aggressive developing move creates immediate pressure. The Giuoco Piano now branches into many rich variations — from the quiet Giuoco Pianissimo with d3 to the sharp tactical battles after d4 and center opens." },
    ]
  },

  {
    ...
    moves: [
      { san: 'e4', commentary: "e4 — the King's Pawn, leading to one of the most explosive and entertaining attacking combinations in all of chess theory." },
      { san: 'e5', commentary: "e5 — Black occupies the center. The Fried Liver Attack will arise from the Italian Game / Two Knights complex." },
      { san: 'Nf3', commentary: "Nf3 — White develops toward the Italian Game setup." },
      { san: 'Nc6', commentary: "Nc6 — Black defends e5. The stage is set for the Italian Game." },
      { san: 'Bc4', commentary: "Bc4 — the Italian bishop targets f7. This is the starting point for the Fried Liver Attack after Black plays Nf6." },
      { san: 'Nf6', commentary: "Nf6 — the Two Knights Defense! Black counter-attacks e4, inviting the legendary Fried Liver. Rather than the solid Bc5, Black immediately counter-attacks, accepting the risk of White's coming sacrifice." },
      { san: 'Ng5', commentary: "Ng5 — the attack begins! White threatens Nxf7 immediately, forking queen and rook. Black must respond carefully — d5 is the only good reply, creating counter-threats in the center." },
      { san: 'd5', commentary: "d5 — the only good response! Black counter-attacks immediately. After exd5 Nxd5, White plays Nxf7! — the Fried Liver Attack! The knight sacrifice on f7 opens the king and forces it forward. After ...Kxf7 Qf3+ Ke6 Nc3, White has a ferocious attack that has terrified players since the 16th century." },
    ]
  },

  {
    ...
    moves: [
      { san: 'e4', commentary: "e4 — the King's Pawn, beginning one of the most aggressive gambits from the 19th century romantic era." },
      { san: 'e5', commentary: "e5 — Black establishes a central pawn. The Danish Gambit will offer not one but two pawns for a ferocious attack." },
      { san: 'd4', commentary: "d4 — the first pawn offer! White immediately challenges the center. After the exchange, White will offer a second pawn for devastating development." },
      { san: 'exd4', commentary: "exd4 — Black accepts the first pawn. Now White will offer a second pawn to gain even more development and open the diagonals for the bishops." },
      { san: 'c3', commentary: "c3 — the Danish Gambit! White offers a second pawn. If Black takes again, White gets both bishops on raking diagonals with tremendous attacking power. This gambit was a feared weapon in the 19th century, popularized in Danish chess circles." },
      { san: 'dxc3', commentary: "dxc3 — Black accepts the second pawn! Now White has lost two pawns but gains rapid development. The bishops will spring to c4 and b2, creating powerful pressure along the a2-g8 and b2-g7 diagonals." },
      { san: 'Bc4', commentary: "Bc4 — the first bishop springs to life! Aimed at f7, creating immediate threats. White's development is now racing ahead. After Nxc3, the b2 bishop will complete the battery, and Black must play very carefully to avoid a devastating early attack." },
      { san: 'cxb2', commentary: "cxb2 — Black captures the third pawn! Now White plays Bxb2 and has two ferociously active bishops aimed at the heart of Black's position. White has sacrificed three pawns for a complete development lead and attacking chances that have broken many kings throughout history." },
    ]
  },

  {
    ...
    moves: [
      { san: 'e4', commentary: "e4 — the King's Pawn. The Center Game is one of the oldest openings, an ambitious attempt to immediately control the center with pawns." },
      { san: 'e5', commentary: "e5 — Black mirrors the center. The Center Game will open the position dramatically on White's next move." },
      { san: 'd4', commentary: "d4 — the Center Game! White immediately challenges the center on move 2. This is more direct than the Scotch (which waits until move 3). After exd4, White has the choice of the Danish Gambit (c3) or recapturing with the queen." },
      { san: 'exd4', commentary: "exd4 — Black captures, opening the center. Now White must decide: recapture with the queen (Center Game) or offer the Danish Gambit with c3." },
      { san: 'Qxd4', commentary: "Qxd4 — the Center Game proper! White recaptures with the queen, placing it on a dominant central square. However, the queen will soon be attacked, costing White time. This is why the Center Game is considered somewhat dubious — White gains a central queen but loses developing tempo." },
      { san: 'Nc6', commentary: "Nc6 — Black attacks the queen! This developing move gains tempo immediately. White must move the queen again, giving Black a free developing move. The queen's early foray into the center is being punished according to classical opening principles." },
      { san: 'Qe3', commentary: "Qe3 — the queen retreats to e3, keeping pressure on the e-file and supporting the center. This is the main line in the Center Game. The queen on e3 eyes the a7-g1 diagonal and supports a possible kingside attack, though it remains somewhat exposed." },
      { san: 'Nf6', commentary: "Nf6 — Black develops with tempo, attacking e4. The position is roughly equal. Black has a comfortable game with active pieces and the advantage of having gained a tempo through Nc6. The Center Game rarely leads to White getting an advantage — it's mostly played as a surprise weapon." },
    ]
  },

  {
    ...
    moves: [
      { san: 'e4', commentary: "e4 — the King's Pawn, leading to the Max Lange Attack, one of the most tactically complex openings of the 19th century." },
      { san: 'e5', commentary: "e5 — Black occupies the center. The Max Lange Attack arises from the Italian Game when Black develops the knight to f6." },
      { san: 'Nf3', commentary: "Nf3 — developing with tempo. White is setting up the Italian Game structure." },
      { san: 'Nc6', commentary: "Nc6 — Black defends e5. The Italian Game complex begins." },
      { san: 'Bc4', commentary: "Bc4 — the Italian bishop! White aims at f7 and sets up for the Max Lange Attack's central pawn break." },
      { san: 'Nf6', commentary: "Nf6 — Black develops aggressively with the Two Knights Defense. Now the Max Lange Attack begins!" },
      { san: 'd4', commentary: "d4 — the Max Lange pawn thrust! White immediately strikes in the center, offering a pawn. If Black takes, White will play e5 (driving the knight) and Bxd4 with a powerful central initiative and attacking chances reminiscent of the Scotch Gambit." },
      { san: 'exd4', commentary: "exd4 — Black accepts! Now after 5.O-O (not immediately e5) Bc5 6.e5 d5 7.exf6 dxc4, the Max Lange Attack proper begins. White has sacrificed material for rapid development and a fierce attacking position. The resulting complications have been analyzed for over 150 years." },
    ]
  },

  {
    ...
    moves: [
      { san: 'e4', commentary: "e4 — the King's Pawn. The Göring Gambit is an aggressive attacking system within the Scotch Game." },
      { san: 'e5', commentary: "e5 — Black establishes a central pawn. The Scotch Game complex will arise after White's next moves." },
      { san: 'Nf3', commentary: "Nf3 — developing with tempo. White is heading for the Scotch Game setup." },
      { san: 'Nc6', commentary: "Nc6 — Black defends e5 while developing. White now plays d4, entering the Scotch Game." },
      { san: 'd4', commentary: "d4 — the Scotch Game! White immediately challenges Black's center, aiming for rapid piece activity." },
      { san: 'exd4', commentary: "exd4 — Black captures in the center. White could recapture with the knight (Scotch Game) but instead plays the Göring Gambit!" },
      { san: 'c3', commentary: "c3 — the Göring Gambit! White offers a pawn for rapid development, similar to the Danish Gambit but in the Scotch Game context. If Black accepts with dxc3, White plays Nxc3 with all pieces developed and dangerous attacking chances. Named after Carl Theodor Göring who analyzed it extensively in the 1870s." },
      { san: 'dxc3', commentary: "dxc3 — Black accepts! After Nxc3, White has a fully developed position with open lines and attacking chances. Black has the extra pawn but must defend carefully. White's pieces will quickly target f7 and control the center. The Göring Gambit leads to sharp, unbalanced play where White's initiative can be very dangerous." },
    ]
  },

  {
    ...
    moves: [
      { san: 'e4', commentary: "e4 — the King's Pawn, leading to the Italian Game complex where Black will choose the solid Hungarian Defense." },
      { san: 'e5', commentary: "e5 — Black occupies the center. The Italian Game complex begins." },
      { san: 'Nf3', commentary: "Nf3 — developing with tempo. White prepares the Italian bishop to c4." },
      { san: 'Nc6', commentary: "Nc6 — Black defends e5. After Bc4, Black has multiple choices — the solid Be7 (Hungarian) is one of them." },
      { san: 'Bc4', commentary: "Bc4 — the Italian bishop takes aim at f7. Now Black must decide: the fighting Bc5 or Nf6, or the solid Hungarian Defense with Be7." },
      { san: 'Be7', commentary: "Be7 — the Hungarian Defense! Black develops the bishop modestly, avoiding the sharp complications of Bc5 or Nf6. This solid but somewhat passive move was popular in the 19th century. Black accepts a slightly cramped position in exchange for a very solid structure with no immediate weaknesses." },
      { san: 'd4', commentary: "d4 — White seizes the center! With Black's bishop passively placed on e7, White can immediately build a powerful central presence. This is the critical test of the Hungarian Defense." },
      { san: 'd6', commentary: "d6 — Black solidifies the position. The Hungarian Defense leads to solid but passive positions for Black. While it avoids sharp theory, Black must be careful not to fall too far behind in the center and activity. A patient, strategic game lies ahead." },
    ]
  },

  // Semi-Open new additions
  {
    ...
    moves: [
      { san: 'e4', commentary: "e4 — the King's Pawn, heading for one of the most dynamic and theoretically challenging Sicilian variations." },
      { san: 'c5', commentary: "c5 — the Sicilian. Black fights for the d4 square asymmetrically, setting up the Sveshnikov's rich counterplay." },
      { san: 'Nf3', commentary: "Nf3 — White develops and prepares d4. The Open Sicilian begins." },
      { san: 'Nc6', commentary: "Nc6 — Black develops the knight. The Sveshnikov requires Nc6 early, supporting the coming e5 advance." },
      { san: 'd4', commentary: "d4 — the critical pawn break. White opens the center and the Sicilian imbalance is created." },
      { san: 'cxd4', commentary: "cxd4 — Black exchanges, opening the c-file. The characteristic Sicilian pawn structure emerges." },
      { san: 'Nxd4', commentary: "Nxd4 — White centralizes the knight powerfully. Now Black plays Nf6 and after Nc3, the Sveshnikov's defining e5 thrust follows." },
      { san: 'Nf6', commentary: "Nf6 — developing and attacking e4. After 5.Nc3, Black plays the defining move 5...e5! — the Sveshnikov! This bold advance accepts a backward d6 pawn and gives White the strong d5 outpost, but in return Black gets powerful piece activity and the e5 space. A favorite of Leko, Carlsen, and many modern elite players." },
    ]
  },

  {
    ...
    moves: [
      { san: 'e4', commentary: "e4 — the King's Pawn. The Kan Sicilian (also called the Paulsen Variation) is one of Black's most flexible responses in the Sicilian." },
      { san: 'c5', commentary: "c5 — the Sicilian begins. Black will reach the Kan by combining c5 with e6 and a6." },
      { san: 'Nf3', commentary: "Nf3 — White develops and prepares d4 for the Open Sicilian." },
      { san: 'e6', commentary: "e6 — Black's first defining move for the Kan. This solid pawn move prepares d5 and keeps the pawn structure flexible." },
      { san: 'd4', commentary: "d4 — the central break. The Open Sicilian pawn structure is created after the exchange." },
      { san: 'cxd4', commentary: "cxd4 — Black opens the c-file. The Sicilian imbalance is established." },
      { san: 'Nxd4', commentary: "Nxd4 — White centralizes the knight. Now Black's choice of a6 will define the Kan." },
      { san: 'a6', commentary: "a6 — the Kan Sicilian! This flexible pawn move prepares b5 and keeps all options open. Unlike the Najdorf (where d6 is already played), the Kan with e6 gives Black maximum flexibility — the position can transpose to Taimanov, Scheveningen, or remain as a pure Kan. A favorite of subtle positional players." },
    ]
  },

  {
    ...
    moves: [
      { san: 'e4', commentary: "e4 — the King's Pawn. The Taimanov Sicilian (named after Soviet grandmaster Mark Taimanov) combines the flexibility of e6 with the development of Nc6." },
      { san: 'c5', commentary: "c5 — the Sicilian begins. The Taimanov will combine c5, e6, and Nc6." },
      { san: 'Nf3', commentary: "Nf3 — developing and preparing the d4 break." },
      { san: 'e6', commentary: "e6 — Black prepares the Taimanov structure. The pawn on e6 supports d5 and keeps the position solid." },
      { san: 'd4', commentary: "d4 — the central break. White opens the center and gains a strong initiative." },
      { san: 'cxd4', commentary: "cxd4 — Black exchanges, opening the c-file for long-term queenside pressure." },
      { san: 'Nxd4', commentary: "Nxd4 — White centralizes the knight on a dominant square. The Sicilian structure is established." },
      { san: 'Nc6', commentary: "Nc6 — the Taimanov! Black develops the knight to c6, creating a solid and flexible position. Unlike the Najdorf or Dragon, the Taimanov avoids many of the sharpest theoretical battles. Black can develop on both wings, and the position can take many different forms. A favorite of players who want a rich game without extreme theoretical demands." },
    ]
  },

  {
    ...
    moves: [
      { san: 'e4', commentary: "e4 — the King's Pawn. The Accelerated Dragon is Black's way of getting the Dragon bishop without allowing the Yugoslav Attack." },
      { san: 'c5', commentary: "c5 — the Sicilian begins. The Accelerated Dragon will develop with g6 before d6." },
      { san: 'Nf3', commentary: "Nf3 — White develops and prepares d4 for the Open Sicilian." },
      { san: 'Nc6', commentary: "Nc6 — Black develops the knight. In the Accelerated Dragon, Nc6 precedes d6." },
      { san: 'd4', commentary: "d4 — the central break creates the Open Sicilian structure." },
      { san: 'cxd4', commentary: "cxd4 — Black exchanges, opening the c-file. The Sicilian imbalance is established." },
      { san: 'Nxd4', commentary: "Nxd4 — White centralizes the knight. Now Black plays g6 to 'accelerate' the Dragon." },
      { san: 'g6', commentary: "g6 — the Accelerated Dragon! Black prepares the fianchetto immediately, without playing d6 first. The key advantage: this move order avoids the Yugoslav Attack (since White's f3+Be3+Qd2+O-O-O setup requires Black to have played d6). The position is similar to the regular Dragon but with important differences — Black can play d5 in one move, often creating tactical shots that don't exist in the regular Dragon." },
    ]
  },

  {
    ...
    moves: [
      { san: 'e4', commentary: "e4 — the King's Pawn. The Alapin Variation is a popular anti-Sicilian weapon that avoids the massive theory of the Open Sicilian." },
      { san: 'c5', commentary: "c5 — the Sicilian Defense. Black fights for d4 asymmetrically, but White has a specific plan to avoid the main lines." },
      { san: 'c3', commentary: "c3 — the Alapin Variation (named after Semyon Alapin)! White prepares d4 with pawn support, planning to build a strong center without playing Nf3 first. This avoids the Open Sicilian entirely. White will play d4 and after the exchange, have a supported central pawn." },
      { san: 'd5', commentary: "d5 — the most principled response! Black immediately counter-attacks in the center. This is the most direct challenge — rather than allowing White to build a comfortable center, Black fights for d4 immediately with d5." },
      { san: 'exd5', commentary: "exd5 — White accepts the central exchange. The position opens up dramatically." },
      { san: 'Qxd5', commentary: "Qxd5 — Black recaptures with the queen, gaining central control. In the Alapin, this queen development is actually quite good — unlike in the Scandinavian, Black's queen on d5 is hard to attack immediately." },
      { san: 'd4', commentary: "d4 — White builds the center. This is the whole point of c3 — a supported d4 pawn. The position is dynamic with open lines and piece activity." },
...

  {
    ...
    moves: [
      { san: 'e4', commentary: "e4 — the King's Pawn. The Smith-Morra Gambit is one of the most aggressive anti-Sicilian weapons, sacrificing a pawn for rapid development." },
      { san: 'c5', commentary: "c5 — the Sicilian Defense. Black prepares to fight asymmetrically for d4, but White has a surprise in store." },
      { san: 'd4', commentary: "d4 — White immediately challenges the center. The Smith-Morra begins with this aggressive pawn thrust." },
      { san: 'cxd4', commentary: "cxd4 — Black accepts, opening the center. Now White offers a second pawn." },
      { san: 'c3', commentary: "c3 — the Smith-Morra Gambit! White offers a second pawn to gain rapid development. Named after Pierre Morra (France) and Ken Smith (USA) who popularized it extensively. Black can accept with dxc3 or decline with various moves, but accepting leads to sharp, tactical battles." },
      { san: 'dxc3', commentary: "dxc3 — Black accepts the gambit! Now White recaptures with the knight, gaining a massive development lead." },
      { san: 'Nxc3', commentary: "Nxc3 — White recaptures and immediately has a fully developed knight on c3. With Bc4 and Nf3 coming, White will have tremendous piece activity while Black is still trying to develop. The Smith-Morra is a feared weapon at club level and has been used successfully even at grandmaster level." },
      { san: 'Nc6', commentary: "Nc6 — Black develops the knight, fighting for central control. The battle is now a race: Black tries to consolidate with the extra pawn while White generates piece activity. White's compensation includes open files, active piece play, and the initiative. The resulting positions are complex and unbalanced — exactly what the gambit player wants." },
    ]
  },

  {
    ...
    moves: [
      { san: 'e4', commentary: "e4 — the King's Pawn. The Grand Prix Attack is a popular and dangerous anti-Sicilian system, aiming for a direct kingside attack." },
      { san: 'c5', commentary: "c5 — the Sicilian Defense. Black aims for counterplay, but White will bypass all Open Sicilian theory." },
      { san: 'Nc3', commentary: "Nc3 — the Grand Prix Attack begins! White develops the knight before playing f4. This specific move order (avoiding Nf3 first) is essential — it prevents Black's ...d5 response from being effective, and prepares the f4 advance that defines the Grand Prix." },
      { san: 'Nc6', commentary: "Nc6 — Black develops naturally, fighting for the center. The game is heading for the characteristic Grand Prix Attack pawn structure." },
      { san: 'f4', commentary: "f4 — the Grand Prix Attack! White aggressively advances the f-pawn, gaining space on the kingside and preparing f5 or e5 advances. This system was heavily used on the British Grand Prix chess circuit in the 1980s, giving it its name. White aims for a direct kingside attack similar to the King's Gambit but with more solidity." },
      { san: 'g6', commentary: "g6 — Black prepares the fianchetto, planning to meet the kingside attack with the powerful g7 bishop. This hypermodern response is the most active — the bishop on g7 will be a powerful defensive and counter-attacking piece." },
      { san: 'Nf3', commentary: "Nf3 — White develops the knight and completes the setup. The Grand Prix Attack formation is taking shape: Nc3, f4, Nf3 with Bb5 or Be2 and castling to follow." },
      { san: 'Bg7', commentary: "Bg7 — the Dragon bishop is in position! Black has a solid hypermodern setup. The game will be a classic battle: White's kingside attack (f4-f5, e5) against Black's counterplay along the long diagonal and queenside play. The Grand Prix Attack leads to rich, attacking chess." },
    ]
  },

  {
    ...
    moves: [
      { san: 'e4', commentary: "e4 — the King's Pawn. The Classical Sicilian is one of the oldest and most respected Sicilian variations." },
      { san: 'c5', commentary: "c5 — the Sicilian begins. The Classical variation uses d6 and Nc6 for a solid, piece-oriented setup." },
      { san: 'Nf3', commentary: "Nf3 — White develops and prepares d4 for the Open Sicilian." },
      { san: 'd6', commentary: "d6 — preparing to develop Nf6 without allowing e5. This flexible move is used in both the Classical Sicilian and the Najdorf depending on the fifth move." },
      { san: 'd4', commentary: "d4 — the central pawn break. White opens the center and gains the initiative." },
      { san: 'cxd4', commentary: "cxd4 — Black exchanges, opening the c-file. The Sicilian pawn structure is established." },
      { san: 'Nxd4', commentary: "Nxd4 — White centralizes the knight. Now Nc6 (rather than Najdorf's a6) defines the Classical." },
      { san: 'Nc6', commentary: "Nc6 — the Classical Sicilian! Black develops the knight to its most natural square, fighting directly for control of the center. Unlike the Najdorf (a6) or Dragon (g6), the Classical focuses on piece development and central control. World Champions Spassky and Fischer both played the Classical extensively." },
    ]
  },
...

  {
    ...
    moves: [
      { san: 'd4', commentary: "d4 — the Queen's Pawn. The Grünfeld Exchange is the most critical test of the Grünfeld Defense." },
      { san: 'Nf6', commentary: "Nf6 — the Indian Defense. Black signals hypermodern intentions, allowing the big center." },
      { san: 'c4', commentary: "c4 — White expands, preparing to build a massive pawn center with e4." },
      { san: 'g6', commentary: "g6 — the Grünfeld fianchetto begins. The bishop on g7 will be the most important piece in the upcoming battle." },
      { san: 'Nc3', commentary: "Nc3 — White develops the knight, preparing e4 and the Exchange Variation." },
      { san: 'd5', commentary: "d5 — the Grünfeld! Black strikes in the center, allowing White to take and build the massive center." },
      { san: 'cxd5', commentary: "cxd5 — the Exchange! White accepts the central dominance. After Nxd5, e4 will create the massive center that Black must attack." },
      { san: 'Nxd5', commentary: "Nxd5 — Black recaptures with the knight. Now White will play e4, creating d4+e4 pawns. Black must immediately counter with c5! and Nc6, directly attacking these pawns. The Grünfeld Exchange leads to the most theoretically intense positions in chess, with forced lines extending 20+ moves into computer-analyzed territory." },
    ]
  },

  {
    ...
    moves: [
      { san: 'd4', commentary: "d4 — the Queen's Pawn. The Russian System is a positional approach to fighting the Grünfeld Defense." },
      { san: 'Nf6', commentary: "Nf6 — the Indian Defense, leading to the Grünfeld." },
      { san: 'c4', commentary: "c4 — White expands. The English-QP setup creates the space advantage." },
      { san: 'g6', commentary: "g6 — Black prepares the Grünfeld fianchetto." },
      { san: 'Nc3', commentary: "Nc3 — White develops the knight, heading for the Grünfeld complex." },
      { san: 'd5', commentary: "d5 — the Grünfeld! Black strikes in the center with the characteristic pawn advance." },
      { san: 'Nf3', commentary: "Nf3 — the Russian System! Rather than cxd5 (Exchange) or e4 (Classical), White develops the knight first. This flexible approach keeps more options open. The Russian System avoids the heavily analyzed Exchange Variation and aims for a more strategic battle." },
      { san: 'Bg7', commentary: "Bg7 — the Grünfeld bishop! On g7, this is the most important piece in Black's position. After O-O, Black will play c5 and challenge White's central control. The Russian System often leads to queen sortie positions with Qb3 and Rb1, creating pressure along the b-file. A sophisticated positional weapon against the Grünfeld." },
    ]
  },

  {
    ...
    moves: [
      { san: 'd4', commentary: "d4 — the Queen's Pawn. The Classical Variation (Qc2) is White's most popular and flexible approach against the Nimzo-Indian." },
      { san: 'Nf6', commentary: "Nf6 — the Indian Defense begins, leading to the Nimzo-Indian complex." },
      { san: 'c4', commentary: "c4 — White expands, preparing the Nimzo setup with Nc3." },
      { san: 'e6', commentary: "e6 — Black prepares the Nimzo-Indian with Bb4, opening the path for the f8 bishop." },
      { san: 'Nc3', commentary: "Nc3 — the required move for the Nimzo-Indian. Now Black can pin this knight." },
      { san: 'Bb4', commentary: "Bb4 — the Nimzo-Indian! Black pins the c3 knight, preventing e4 and threatening to double White's pawns." },
      { san: 'Qc2', commentary: "Qc2 — the Classical Variation! White defends c3 with the queen, preventing Bxc3+ doubling. This is White's most popular and flexible response. The queen on c2 also prepares e4 and a4. While the queen move looks awkward, it creates a very solid position where White retains the c4 pawn and the pawn structure." },
      { san: 'O-O', commentary: "O-O — Black castles, bringing the king to safety. The Classical Nimzo leads to rich, strategic battles. White aims for e4 and central control, while Black plans ...d5 or ...c5 counter-attacks. One of the most theoretically important positions in chess, played at the highest level for decades." },
    ]
  },

  {
    ...
    moves: [
      { san: 'd4', commentary: "d4 — the Queen's Pawn. The Rubinstein Variation is the most solid and popular system against the Nimzo-Indian." },
      { san: 'Nf6', commentary: "Nf6 — the Indian Defense, heading for the Nimzo-Indian." },
      { san: 'c4', commentary: "c4 — White expands, building the Queen's Indian/Nimzo complex." },
      { san: 'e6', commentary: "e6 — Black prepares the Nimzo pin." },
      { san: 'Nc3', commentary: "Nc3 — White places the knight where it can be pinned." },
      { san: 'Bb4', commentary: "Bb4 — the Nimzo-Indian pin! Black threatens to double White's pawns." },
      { san: 'e3', commentary: "e3 — the Rubinstein System! White plays quietly, supporting d4 and preparing to develop the f1 bishop. This is the most popular Nimzo-Indian system at the highest level. Named after Akiba Rubinstein, who used it extensively. White accepts that e4 will be delayed but gets a solid, reliable position." },
      { san: 'b6', commentary: "b6 — Black prepares to fianchetto the queen's bishop. From b7, the bishop will exert pressure on the long diagonal. This is a very solid response in the Rubinstein Nimzo, leading to rich strategic battles where both sides maneuver carefully. The Rubinstein Nimzo is a cornerstone of opening theory at grandmaster level." },
    ]
  },
...

  {
    ...
    moves: [
      { san: 'd4', commentary: "d4 — the Queen's Pawn. The King's Indian Sämisch is one of the sharpest and most aggressive systems against the KID." },
      { san: 'Nf6', commentary: "Nf6 — the Indian Defense. Black signals hypermodern intentions, allowing White to build the center." },
      { san: 'c4', commentary: "c4 — White expands, building toward the massive center." },
      { san: 'g6', commentary: "g6 — the King's Indian fianchetto begins." },
      { san: 'Nc3', commentary: "Nc3 — White develops the knight, supporting d4 and preparing e4." },
      { san: 'Bg7', commentary: "Bg7 — the King's Indian Dragon bishop! This is the soul of the KID — a powerful piece on g7." },
      { san: 'f3', commentary: "f3 — the Sämisch Variation! White plays f3 before e4, building a massive center while preventing Ng4. This aggressive approach leads to some of the sharpest positions in the King's Indian. After e4 d6 Be3, White aims for a kingside or queenside attack while Black typically launches the thematic e5 or c5 counter-attacks. A brutal fighting opening." },
...

  {
    ...
    moves: [
      { san: 'd4', commentary: "d4 — the Queen's Pawn. The Four Pawns Attack is White's most ambitious attempt to refute the King's Indian Defense." },
      { san: 'Nf6', commentary: "Nf6 — the Indian Defense. Black allows the big center, trusting in the hypermodern counterplay." },
      { san: 'c4', commentary: "c4 — White expands, building toward the Four Pawns center." },
      { san: 'g6', commentary: "g6 — Black prepares the King's Indian fianchetto, accepting the challenge." },
      { san: 'Nc3', commentary: "Nc3 — White develops the knight. The Four Pawns Attack requires both knights developed before the f4 push." },
      { san: 'Bg7', commentary: "Bg7 — the King's Indian bishop is in position. Black's setup is ready for the upcoming central battle." },
      { san: 'e4', commentary: "e4 — White builds the pawn center. After d6 and f4, White will have the colossal four-pawn center: c4-d4-e4-f4." },
...

  {
    ...
    moves: [
      { san: 'd4', commentary: "d4 — the Queen's Pawn. The Petrosian System is named after World Champion Tigran Petrosian, who used it to neutralize the King's Indian with his trademark positional squeeze." },
      { san: 'Nf6', commentary: "Nf6 — the Indian Defense. Black sets up the King's Indian." },
      { san: 'c4', commentary: "c4 — White expands, building the English-QP structure." },
      { san: 'g6', commentary: "g6 — the King's Indian fianchetto." },
      { san: 'Nc3', commentary: "Nc3 — White develops the knight, supporting d4." },
      { san: 'Bg7', commentary: "Bg7 — the King's Indian Dragon bishop is in position." },
      { san: 'e4', commentary: "e4 — White builds the central pawn structure. After d6 and the Petrosian's key move d5, the game changes character completely." },
...

  {
    ...
    moves: [
      { san: 'd4', commentary: "d4 — the Queen's Pawn. The Averbakh Variation is named after Soviet grandmaster Yuri Averbakh, a positional system against the King's Indian." },
      { san: 'Nf6', commentary: "Nf6 — the Indian Defense, leading to the King's Indian." },
      { san: 'c4', commentary: "c4 — White expands, building the English-QP setup." },
      { san: 'g6', commentary: "g6 — the King's Indian fianchetto. Black prepares the Dragon bishop." },
      { san: 'Nc3', commentary: "Nc3 — White develops the knight, supporting d4." },
      { san: 'Bg7', commentary: "Bg7 — the King's Indian bishop on g7, ready to fight for the center." },
      { san: 'e4', commentary: "e4 — White builds the powerful center. The Averbakh Variation will distinguish itself after d6 with 5.Be2 O-O 6.Bg5, pinning Black's knight." },
...

  {
    ...
    moves: [
      { san: 'd4', commentary: "d4 — the Queen's Pawn. The Modern Benoni is one of the most dynamic and unbalanced defenses in chess, a fighting weapon beloved by players like Fischer and Tal." },
      { san: 'Nf6', commentary: "Nf6 — the Indian Defense. Black signals the Benoni with the knight developing first." },
      { san: 'c4', commentary: "c4 — White expands, building toward the Benoni pawn structure." },
      { san: 'c5', commentary: "c5 — Black's key move! This creates the Benoni pawn tension. After d5, the game will feature Black's queenside majority against White's central space." },
      { san: 'd5', commentary: "d5 — White closes the center! Rather than dxc5, White advances, creating the characteristic Benoni pawn structure. Black has a queenside pawn majority (a5-b5-c5) while White has the central space (e4-d5). This imbalance leads to dynamic, fighting games." },
      { san: 'e6', commentary: "e6 — Black immediately challenges the d5 pawn. The tension will be resolved by exd5." },
      { san: 'Nc3', commentary: "Nc3 — White develops the knight, supporting d5 and e4." },
      { san: 'exd5', commentary: "exd5 — Black captures, opening the e-file. Now cxd5 gives Black the typical Benoni pawn structure: Black has a pawn on c5 facing White's d5, and typically aims for e5 or b5 breaks. The Benoni leads to rich attacking chess where Black typically attacks the kingside while White expands on the queenside. A favorite of Fischer and Tal." },
    ]
  },

  {
    ...
    moves: [
      { san: 'd4', commentary: "d4 — the Queen's Pawn. The Four Pawns Attack against the Benoni is White's most aggressive option, aiming to build an overwhelming center." },
      { san: 'Nf6', commentary: "Nf6 — the Indian Defense, leading to the Benoni complex." },
      { san: 'c4', commentary: "c4 — White expands, building toward the Benoni structure." },
      { san: 'c5', commentary: "c5 — Black's Benoni move! This creates the characteristic pawn tension." },
      { san: 'd5', commentary: "d5 — White advances, closing the center and beginning the Benoni." },
      { san: 'd6', commentary: "d6 — Black solidifies the position and prepares to challenge the center." },
      { san: 'Nc3', commentary: "Nc3 — White develops the knight, preparing the massive center." },
      { san: 'g6', commentary: "g6 — Black prepares the King's Indian-style fianchetto. After 5.e4 Bg7 6.f4, White has the Four Pawns Attack formation: c4-d5-e4-f4. This massive center gives White enormous space but creates potential overextension. Black's typical plan is e5 or b5 to undermine the center. The Four Pawns Attack leads to extremely sharp, double-edged play." },
    ]
  },

  {
    ...
    moves: [
      { san: 'd4', commentary: "d4 — the Queen's Pawn. The Budapest Gambit is a bold counter-gambit that immediately disrupts White's plans." },
      { san: 'Nf6', commentary: "Nf6 — the Indian Defense. Black is preparing the Budapest counter-gambit." },
      { san: 'c4', commentary: "c4 — White expands. Now Black springs the Budapest Gambit." },
      { san: 'e5', commentary: "e5 — the Budapest Gambit! Black immediately sacrifices a pawn to attack White's pawn on d4 (now d5 after dxe5). This bold gambit dates to the early 20th century and was analyzed by many Hungarian masters (giving it its name). Black gets immediate piece activity in exchange for the pawn." },
      { san: 'dxe5', commentary: "dxe5 — White accepts the gambit. Now Black attacks the e5 pawn with the knight." },
      { san: 'Ng4', commentary: "Ng4 — attacking the e5 pawn! The knight jumps in aggressively. Black will regain the pawn with active piece play. After Nf3 Bc5 (or Ne3), Black has excellent activity and the initiative." },
      { san: 'Nf3', commentary: "Nf3 — White defends the e5 pawn and continues development." },
      { san: 'Bc5', commentary: "Bc5 — Black develops the bishop aggressively, aiming at f2. The Budapest Gambit leads to open, dynamic positions where Black has active pieces and tactical possibilities. While objectively Black may be slightly worse with perfect play, the Budapest is a very practical weapon in practical play — especially in rapid and blitz games." },
    ]
  },

  {
    ...
    moves: [
      { san: 'd4', commentary: "d4 — the Queen's Pawn. The Bogo-Indian Defense arises when White plays Nf3 instead of Nc3 on move 3, and Black responds with Bb4+." },
      { san: 'Nf6', commentary: "Nf6 — the Indian Defense. Black keeps the game flexible, waiting for White's third move." },
      { san: 'c4', commentary: "c4 — White expands, building the English-QP structure." },
      { san: 'e6', commentary: "e6 — Black prepares the Indian Defense setup. If White plays Nc3, we'd have the Nimzo-Indian. But Nf3 leads to the Bogo." },
      { san: 'Nf3', commentary: "Nf3 — White plays Nf3 specifically to avoid the Nimzo-Indian (which requires Nc3). Now Black has the option of the Bogo-Indian with Bb4+." },
      ...
      { san: 'Bd2', commentary: "Bd2 — the most common response! White blocks the check and offers to exchange bishops. After Bxd2+ (or the more complex Qe7), Black surrenders the bishop pair but gets solid equality. The bishop pair is White's main compensation in this variation." },
      { san: 'Qe7', commentary: "Qe7 — Black retreats the bishop and develops the queen! Rather than exchanging on d2, Black keeps the bishop and places the queen actively on e7. This leads to rich strategic play. The Bogo-Indian is a solid, reliable defense that avoids much of the Nimzo-Indian's complex theory while maintaining good counterplay for Black." },
    ]
  },

  {
    ...
    moves: [
      { san: 'd4', commentary: "d4 — the Queen's Pawn. The Old Indian Defense is a classical system where Black builds a solid center with e5." },
      { san: 'Nf6', commentary: "Nf6 — the Indian Defense. The Old Indian will develop with d6 and e5 rather than the King's Indian's g6 and Bg7." },
      { san: 'c4', commentary: "c4 — White expands, building toward the Old Indian structure." },
      { san: 'd6', commentary: "d6 — the Old Indian! Black prepares e5 and a solid central structure. Unlike the King's Indian, Black will keep the king's bishop on the e7-f8 diagonal rather than fianchettoing." },
      { san: 'Nc3', commentary: "Nc3 — White develops the knight, supporting d4 and preparing e4." },
      { san: 'e5', commentary: "e5 — the Old Indian center! Black seizes central space, creating a position similar to the King's Indian but without the fianchetto. The e5 pawn is Black's main central asset." },
      { san: 'Nf3', commentary: "Nf3 — White develops the knight and prepares Be2 or d5. White must decide whether to advance in the center or maintain the tension." },
      { san: 'Nbd7', commentary: "Nbd7 — developing the knight to d7, preparing to support e5 or jump to c5. The Old Indian leads to solid, strategic positions. While not as sharp as the King's Indian, the Old Indian is a reliable system that has been used by many grandmasters throughout history. Black's solid structure makes it difficult for White to achieve a quick breakthrough." },
    ]
  },

  {
    ...
    moves: [
      { san: 'd4', commentary: "d4 — the Queen's Pawn. The Leningrad Dutch is one of the most dynamic and aggressive variations of the Dutch Defense." },
      { san: 'f5', commentary: "f5 — the Dutch Defense! Black fights for the e4 square and prepares kingside activity from the very first move." },
      { san: 'g3', commentary: "g3 — White fianchettoes, creating a powerful Bg2 bishop aimed at Black's kingside. This is the most popular anti-Dutch setup." },
      { san: 'Nf6', commentary: "Nf6 — Black develops the knight. The Leningrad variation will emerge with the kingside fianchetto." },
      { san: 'Bg2', commentary: "Bg2 — the Catalan bishop is powerfully placed, targeting the f3 square and creating long-diagonal pressure." },
      { san: 'g6', commentary: "g6 — the Leningrad! Black prepares the kingside fianchetto, creating a hypermodern counterattacking setup. The Leningrad Dutch is named after the strong Leningrad (now St. Petersburg) chess school that developed and popularized this variation." },
      { san: 'Nf3', commentary: "Nf3 — White develops the knight and prepares to castle. White's setup is harmonious and flexible." },
      { san: 'Bg7', commentary: "Bg7 — the Leningrad bishop is in position! Black now has two powerful bishops on the long diagonals — Bg7 and the future dark-squared bishop. The Leningrad Dutch creates a flexible, dynamic setup where Black can play ...d6 and ...Nc6 with queenside counterplay, or advance with ...d5 for a more direct central battle." },
    ]
  },

  {
    ...
    moves: [
      { san: 'd4', commentary: "d4 — the Queen's Pawn. The Dutch Stonewall is one of chess's most distinctive and solid defensive formations." },
      { san: 'f5', commentary: "f5 — the Dutch Defense begins. The Stonewall will develop with d5, e6, and c6 to create an impenetrable pawn structure." },
      { san: 'g3', commentary: "g3 — White fianchettoes, the standard anti-Dutch approach." },
      { san: 'Nf6', commentary: "Nf6 — Black develops the knight and prepares to build the Stonewall formation." },
      { san: 'Bg2', commentary: "Bg2 — the powerful fianchettoed bishop will try to exploit the gaps created by Black's Stonewall formation." },
      { san: 'e6', commentary: "e6 — Black builds the Stonewall! This move begins the rigid pawn structure e6-d5-c6-f5. While immobile, this formation is extremely solid and gives Black a powerful knight on e4." },
      { san: 'Nf3', commentary: "Nf3 — White develops the knight and prepares to castle. White will try to exploit the gaps in Black's Stonewall, particularly the light squares created by the fixed pawns." },
      { san: 'd5', commentary: "d5 — completing the Stonewall! The pawn formation f5-e6-d5-c6 creates the 'stonewall' — an impenetrable defensive barrier. Black's knight on e4 will be a powerful outpost. The Stonewall was a favorite of Botvinnik and is still played today at all levels. The weakness is the light squares, which White will try to exploit with a Bg5-Bh4 maneuver." },
    ]
  },

  {
    ...
    moves: [
      { san: 'd4', commentary: "d4 — the Queen's Pawn. The Colle System is a reliable, systematic opening that avoids extensive theory and leads to attacking positions." },
      { san: 'd5', commentary: "d5 — Black meets the center challenge. The Colle is named after Belgian master Edgar Colle, who popularized it in the 1920s." },
      { san: 'Nf3', commentary: "Nf3 — White develops the knight naturally, the starting point of the Colle System." },
      { san: 'Nf6', commentary: "Nf6 — Black develops the knight to its best square." },
      { san: 'e3', commentary: "e3 — the Colle move! White plays e3 before developing the bishop. This solid approach keeps options open and prepares Bd3 and c3." },
      { san: 'e6', commentary: "e6 — Black builds a solid structure with e6 reinforcing d5." },
      { san: 'Bd3', commentary: "Bd3 — the Colle bishop! On d3, it targets the h7 pawn and is ready to support a kingside attack. After c3 and Nbd2, White will play e4 and the position opens up dramatically. The Colle System is a wonderful practical weapon that surprises many opponents who expect main-line theory." },
      { san: 'c5', commentary: "c5 — Black immediately challenges White's center. This is the most active response to the Colle. After dxc5 Bxc5 or c3 Nc6, the game becomes dynamic. The Colle leads to rich middlegame play where White typically launches a kingside attack, often featuring sacrifices on h7 or e5." },
    ]
  },

  {
    ...
    moves: [
      { san: 'd4', commentary: "d4 — the Queen's Pawn. The Torre Attack is named after Carlos Torre, the Mexican grandmaster who developed it in the 1920s." },
      { san: 'Nf6', commentary: "Nf6 — the Indian Defense. Black attacks e4 and signals flexible intentions, but White has an immediate response." },
      { san: 'Nf3', commentary: "Nf3 — White develops the knight before the bishop move, setting up the Torre." },
      { san: 'e6', commentary: "e6 — Black builds a solid structure. The Torre Attack is less sharp against the KID (g6) than against solid setups like this." },
      { san: 'Bg5', commentary: "Bg5 — the Torre Attack! White immediately pins the f6 knight, creating early pressure. This sidesteps all the main Indian defenses (Nimzo, Queen's Indian, KID) and leads to original positions. The Torre is a practical weapon — not deeply theoretical but consistently solid." },
      { san: 'd5', commentary: "d5 — Black challenges the center and develops normally. The Torre Attack doesn't create immediate threats so Black can develop naturally." },
      { san: 'e3', commentary: "e3 — White solidifies the position and prepares to complete development. The Torre System often involves e3, Nbd2, c3, and Bd3, building a solid attacking setup." },
...

  {
    ...
    moves: [
      { san: 'd4', commentary: "d4 — the Queen's Pawn. The Blackmar-Diemer Gambit is one of chess's most aggressive d4 openings, sacrificing a pawn for rapid development and attack." },
      { san: 'd5', commentary: "d5 — Black meets the center with a center pawn. The BDG arises when White immediately attacks this pawn with e4." },
      { san: 'e4', commentary: "e4 — the Blackmar-Diemer begins! White immediately offers a pawn to open the position. This gambit transforms a Queen's Pawn opening into a wild tactical battle instantly." },
      { san: 'dxe4', commentary: "dxe4 — Black accepts! The pawn center is liquidated and White will sacrifice another pawn with f3." },
      { san: 'Nc3', commentary: "Nc3 — White develops the knight, supporting the center and preparing f3." },
      { san: 'Nf6', commentary: "Nf6 — Black develops the knight to its best square, defending the e4 pawn." },
      { san: 'f3', commentary: "f3 — the BDG sacrifice! White attacks the e4 pawn with f3, sacrificing this pawn for rapid development. After exf3, White plays Nxf3 and has fully developed pieces with open lines and attacking chances." },
      { san: 'exf3', commentary: "exf3 — Black accepts the second pawn! White now plays Nxf3 with a completely open position and lead in development. The Blackmar-Diemer Gambit leads to some of the most tactical and entertaining games at club level. While objectively the compensation is questionable, White's practical attacking chances make it a feared weapon." },
    ]
  },

  {
    ...
    moves: [
      { san: 'd4', commentary: "d4 — the Queen's Pawn. The Veresov Attack (named after Soviet grandmaster Gavriil Veresov) is an aggressive sideline that creates immediate complications." },
      { san: 'Nf6', commentary: "Nf6 — the Indian Defense. Black develops the knight, and White will immediately attack it with Nc3 and Bg5." },
      { san: 'Nc3', commentary: "Nc3 — the Veresov! Rather than the standard c4 or Nf3, White develops the queen's knight first. This prepares Bg5 to pin the f6 knight immediately." },
      { san: 'd5', commentary: "d5 — Black challenges the center, the most principled response. Black aims for a solid QGD-style position." },
      { san: 'Bg5', commentary: "Bg5 — the Veresov pin! White immediately pins the f6 knight. This creates early pressure and forces Black to make concrete decisions. The Veresov sidesteps the heavily analyzed Indian defenses and leads to original, less-explored territory." },
      { san: 'Nbd7', commentary: "Nbd7 — Black develops the knight from b8 to d7, preparing to support the Nf6 knight. This is one of the most solid responses to the Veresov." },
      { san: 'Nf3', commentary: "Nf3 — White develops the knight and maintains the pin pressure. The position is complex and original." },
      { san: 'e6', commentary: "e6 — Black solidifies the pawn structure and prepares to develop the f8 bishop. The Veresov Attack leads to rich middlegame play outside of mainstream theory. White typically tries to use piece pressure and attacking chances, while Black relies on solid development and central control." },
    ]
  },

  {
    ...
    moves: [
      { san: 'd4', commentary: "d4 — the Queen's Pawn. The Stonewall Attack is White's version of the Dutch Defense — a systematic attacking setup." },
      { san: 'd5', commentary: "d5 — Black meets the center with a center pawn. The Stonewall works regardless of Black's setup." },
      { san: 'e3', commentary: "e3 — White builds the Stonewall! Rather than c4, White begins the systematic Stonewall formation. The e3-f4-d4 pawn triangle will be the backbone of White's position." },
      { san: 'Nf6', commentary: "Nf6 — Black develops the knight naturally." },
      { san: 'Bd3', commentary: "Bd3 — the Stonewall bishop! On d3, the bishop is perfectly placed for the upcoming kingside attack, targeting the h7 pawn." },
      { san: 'e6', commentary: "e6 — Black builds a solid structure, similar to the QGD." },
      { san: 'f4', commentary: "f4 — the Stonewall complete! White forms the rigid but powerful d4-e3-f4 pawn triangle. This controls the e5 square and prepares a kingside attack with Nf3, O-O, and eventually Ne5." },
      { san: 'c5', commentary: "c5 — Black challenges White's center. The most active response to the Stonewall. After dxc5 or c3, the game becomes dynamic. Black seeks queenside counterplay while White builds the kingside attack. A practical weapon that leads to rich middlegame play, often featuring piece sacrifices around the Black king." },
    ]
  },

  {
    ...
    moves: [
      { san: 'c4', commentary: "c4 — the English Opening. The Symmetrical English arises when Black mirrors White's c4 with c5." },
      { san: 'c5', commentary: "c5 — the Symmetrical English! Black mirrors White's pawn move, creating an immediate symmetric position. This is the most principled response to the English, leading to very rich strategic battles where small positional advantages are the key." },
      { san: 'Nc3', commentary: "Nc3 — White develops the knight, supporting d4 and preparing to fight for the center." },
      { san: 'Nc6', commentary: "Nc6 — Black mirrors the development symmetrically. The Symmetrical English is characterized by this mirror-like play." },
      { san: 'g3', commentary: "g3 — White prepares the fianchetto. The Symmetrical English with g3 is the most popular setup, leading to the four-knights variant after Nf3 g6 Bg2 Bg7." },
      { san: 'g6', commentary: "g6 — Black mirrors the fianchetto! Both sides will develop their bishops to g2 and g7, creating the classic Symmetrical English dragon-bishop battle." },
      { san: 'Bg2', commentary: "Bg2 — White's bishop is in position on the long diagonal, controlling the center." },
      { san: 'Bg7', commentary: "Bg7 — Black's bishop mirrors White's! The Symmetrical English with both fianchettoed bishops leads to incredibly strategic and subtle positions. The game will be decided by small advantages in piece placement, pawn breaks (d4 for White, d5 for Black), and endgame technique. A favorite of sophisticated positional players." },
    ]
  },

  {
    ...
    moves: [
      { san: 'c4', commentary: "c4 — the English Opening. The Four Knights variation is a solid and principled response to the English." },
      { san: 'Nf6', commentary: "Nf6 — Black develops the knight, the most popular response to the English Opening." },
      { san: 'Nc3', commentary: "Nc3 — White develops the queen's knight to its best square." },
      { san: 'Nc6', commentary: "Nc6 — Black develops the second knight! Both sides are developing all four knights early, leading to the English Four Knights." },
      { san: 'Nf3', commentary: "Nf3 — White's second knight is developed. All four knights are now in play." },
      { san: 'e5', commentary: "e5 — Black claims central space! This is the most ambitious and principled response — Black builds a strong e5 pawn supported by the knights." },
      { san: 'e3', commentary: "e3 — White solidifies the position and prepares Be2. White will castle quickly and fight for central control." },
...

  {
    ...
    moves: [
      { san: 'c4', commentary: "c4 — the English Opening. Black will respond with a King's Indian setup, creating a reversed flank structure." },
      { san: 'Nf6', commentary: "Nf6 — the Indian Defense setup. Black will develop the KID structure against the English." },
      { san: 'Nc3', commentary: "Nc3 — White develops the knight, building the English setup." },
      { san: 'g6', commentary: "g6 — the King's Indian fianchetto! Black will develop the bishop to g7, creating the same Dragon formation as in the KID." },
      { san: 'g3', commentary: "g3 — White also fianchettoes! This leads to the battle of the two Dragon bishops on opposing long diagonals." },
      { san: 'Bg7', commentary: "Bg7 — the King's Indian Dragon bishop is in position, controlling the a1-h8 diagonal." },
      { san: 'Bg2', commentary: "Bg2 — White's bishop occupies the h1-a8 diagonal. Now both bishops control the center from opposite sides — a deep strategic battle for diagonal dominance." },
      { san: 'O-O', commentary: "O-O — Black castles, the king is safe. The English vs King's Indian leads to complex positional battles. White will typically play d4 to transpose into a King's Indian or keep the extra tempo with e4. Black has the same setup as in the KID but with colors reversed, which can lead to subtle differences in the subsequent play." },
    ]
  },

  {
    ...
    moves: [
      { san: 'Nf3', commentary: "Nf3 — the King's Indian Attack begins! White develops the knight first, keeping the pawn structure flexible. The KIA is a system, not just an opening — it can be played against almost any Black setup." },
      { san: 'd5', commentary: "d5 — Black claims central space. The KIA can be played against any Black setup, but the French/Sicilian formations are most common." },
      { san: 'g3', commentary: "g3 — White prepares the fianchetto. The KIA formation: Nf3, g3, Bg2, O-O, d3, Nbd2, and then e4 for the central push." },
      { san: 'Nf6', commentary: "Nf6 — Black develops the knight, fighting for the center." },
      { san: 'Bg2', commentary: "Bg2 — the KIA bishop is in position. On g2, this bishop will be a powerful attacking piece once White plays e4 and the position opens up." },
      { san: 'c5', commentary: "c5 — Black builds a strong center with both c5 and d5. This is the Reversed King's Indian structure for Black." },
      { san: 'O-O', commentary: "O-O — White castles quickly, the king is safe. The KIA formation is almost complete. After d3 and Nbd2, White will play e4, the central advance that defines the KIA attack." },
      { san: 'Nc6', commentary: "Nc6 — Black develops the knight. The KIA vs Sicilian-type structure (c5 + Nc6) is one of the most common KIA set-ups. After d3 g6 Nbd2 Bg7 e4, the KIA is in full flow. Bobby Fischer used the KIA extensively in the 1960s, winning many brilliant attacking games. It remains popular at all levels today." },
    ]
  },

  {
    ...
    moves: [
      { san: 'b3', commentary: "b3 — the Nimzo-Larsen Attack (also called Larsen's Opening)! White immediately prepares to fianchetto the queen's bishop. This unorthodox first move was popularized by Danish grandmaster Bent Larsen and was also played by Nimzowitsch. White will develop Bb2 and aim to control the center from a distance." },
      { san: 'e5', commentary: "e5 — Black claims the center! The most aggressive and principled response. By occupying e5, Black immediately fights for space and challenges White's hypermodern approach." },
      { san: 'Bb2', commentary: "Bb2 — the Larsen bishop! On b2, the bishop controls the important a1-h8 diagonal. White will follow with e3, Nf3, and Be2, building a solid position with long-range piece pressure." },
      { san: 'Nc6', commentary: "Nc6 — Black develops the knight, supporting e5 and fighting for central control." },
      { san: 'e3', commentary: "e3 — White solidifies the position and prepares to develop the kingside." },
      { san: 'Nf6', commentary: "Nf6 — Black develops the second knight, attacking e4 (which doesn't exist here) and preparing to castle." },
      { san: 'Nf3', commentary: "Nf3 — White develops the knight and prepares to castle. The Nimzo-Larsen formation is solidifying." },
      { san: 'e4', commentary: "e4 — Black advances aggressively! The e-pawn pushes to e4, attacking the f3 knight and seizing space. Now White must decide: retreat the knight or find other plans? The Nimzo-Larsen Attack leads to rich, unorthodox positions where Black often has extra central space but White has the powerful Bb2 bishop. A favorite of players who want to avoid all mainstream theory." },
    ]
  },

  {
    ...
    moves: [
      { san: 'b4', commentary: "b4 — the Polish Opening! Also called the Orangutan (named after a 1924 game where Réti visited the Bronx Zoo before the game). White immediately seizes queenside space and prepares Bb2. This surprising first move has been used by world-class players including Tartakower, who championed it extensively." },
      { san: 'e5', commentary: "e5 — the most fighting response! Black immediately occupies the center, refusing to let White gain space for free." },
      { san: 'Bb2', commentary: "Bb2 — the Polish bishop! On b2, the bishop aims powerfully along the a1-h8 diagonal. White's idea is to pressure e5 and control the center from the flank." },
      { san: 'Nc6', commentary: "Nc6 — Black develops the knight and supports e5. The position is now becoming complex as both sides fight for central control." },
      { san: 'c4', commentary: "c4 — White expands on the queenside! The Polish b4-Bb2-c4 combination creates a unique type of queenside pressure. White aims for a Catalan-like setup where the queenside pieces dominate." },
      { san: 'Nf6', commentary: "Nf6 — Black develops the kingside knight, preparing to castle and fight for the center." },
      { san: 'e3', commentary: "e3 — White solidifies the position and prepares Be2 for rapid castling. The Polish Opening is now transitioning into a more standard-looking position, though the b4 pawn gives White a unique queenside advantage." },
      { san: 'd5', commentary: "d5 — Black challenges the center! This counter-thrust creates immediate tension. After cxd5 Nxd5 or b5, the position is complex with both sides having their unique advantages. The Polish Opening leads to original, creative chess away from all mainstream theory — a favorite for players who want to fight without memorizing hundreds of moves." },
    ]
  },
